...
var CatalogItem = function(terria) {
    ...
    /**
     * Edited
     * Gets the number of results if it was originated from a catalog function
     * @type {String}
     */
    ...
    /**
     * Edited
     * Gets the json code with all the results
     * @type {String}
     */
    this.json = undefined;
...
CatalogItem.defaultUpdaters.attribution = function(catalogItem, json, prototypeName) {
    if(defined(json.attribution)){
        if((typeof json.attribution === 'object' && json.attribution.text) && json.attribution.link ){
            catalogItem.attribution = new Credit({
                text: json.attribution.text,
                imageUrl: undefined,
                link: json.attribution.link
            });
        }else if(typeof json.attribution === 'string'){
            catalogItem.attribution = new Credit({
                text: json.attribution,
                imageUrl: undefined,
                link: undefined
            });
        }
