...
var ObjectCsvCatalogItem = require('./ObjectCsvCatalogItem');
...
var EuropeanaJsonCatalogFunction = require('./EuropeanaJsonCatalogFunction');
var RepositoryJsonCatalogFunction = require('./RepositoryJsonCatalogFunction');
var RepositoryLocationCatalogFunction = require('./RepositoryLocationCatalogFunction');
var PersonalJsonCatalogFunction = require('./PersonalJsonCatalogFunction');
...
var registerCatalogMembers = function() {
    ...
    createCatalogMemberFromType.register('object-csv', ObjectCsvCatalogItem);
    ...
    createCatalogMemberFromType.register('europeana-json', EuropeanaJsonCatalogFunction);
    createCatalogMemberFromType.register('cho-json', RepositoryJsonCatalogFunction);
    createCatalogMemberFromType.register('chol-json', RepositoryLocationCatalogFunction);
    createCatalogMemberFromType.register('p-json', PersonalJsonCatalogFunction);
