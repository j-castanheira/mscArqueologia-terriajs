...
RepositoryJsonCatalogFunction.prototype.invoke = function () {
    ...
    queryParameters["term"] = this.parameters[0].value;
    if(this.parameters[1].value)
    queryParameters["disableCombine"] = "true";

    let rep = -1;
    switch(this.parameters[2].value)
    {
        case "Europeana": rep = 1; break;
        case "The Fitzwilliam Museum": rep = 2; break;
        case "DigitalNZ": rep = 3; break;
        case "Cultura Casas Religiosas": rep = 4; break;
        case "Museum Victoria Repository": rep = 5; break;
        case "Estatuaria Lisboa Repository": rep = 6; break;
    }
    if(rep!=-1)
    queryParameters["repositories"] = rep;
