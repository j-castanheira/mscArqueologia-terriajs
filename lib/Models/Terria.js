...
var Terria = function(options) {
    ...
    /**
     * Json for personal objects. EDITED //"Id,Title,Creator,Description,Temporal,Location,Latitude,Longitude,Preview,Type,Repository,SourcePage,SourceData\n";
     * @type {{results: Array, count: number}}
     */
    ...
    knockout.track(this, [
        ...
        'baseMapContrastColor', 'personalObjects'
    ]);
