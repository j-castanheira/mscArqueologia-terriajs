...
var videoIcon = require('../../wwwroot/images/video.png');
var imageIcon = require('../../wwwroot/images/image.png');
var textIcon = require('../../wwwroot/images/text.png');
var modelIcon = require('../../wwwroot/images/cube.png');
 ...
 *
 * @name ObjectTableDataSource
 *
 * @alias ObjectTableDataSource
 * @constructor
 ...
 */
var ObjectTableDataSource = function (terria, tableStructure, tableStyle, name, isUpdating) {
     ...
     * @memberof ObjectTableDataSource.prototype
     * @type {TableStyle}
     */
    ...
    knockout.track(this, ['_tableStructure', '_rowObjects','_legendHelper', '_legendUrl', '_extent']);
...
defineProperties(ObjectTableDataSource.prototype, {
    /**
...
ObjectTableDataSource.prototype.loadFromCsv = function (csvString) {
...
// EDITED
// Adds a the type of billboard for each type
            ...
            if (!nanErrorDisplayed) {
                // Only show this error once even if there are lots of badly formed rows
                 dataSource._terria.error.raiseEvent(new TerriaError({
                    sender: dataSource,
                    title: 'Invalid characters in latitude and longitude columns (Object)',
 ...
 */
ObjectTableDataSource.prototype.destroy = function () {
    // Do we need to explicitly unsubscribe from the clock?
    return destroyObject(this);
};

module.exports = ObjectTableDataSource;
