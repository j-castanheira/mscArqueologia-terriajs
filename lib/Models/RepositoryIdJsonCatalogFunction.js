 ...
 * {@link RepositoryJsonCatalogFunction#inputs} property, and expects to receive back TerriaJS catalog/share JSON.
 *
 ...
 * ```
 *
 * @alias RepositoryJsonCatalogFunction
 * @constructor
 * @extends CatalogFunction
 *
 * @param {Terria} terria The Terria instance.
 */
function RepositoryIdJsonCatalogFunction(terria) {
...
inherit(CatalogFunction, RepositoryIdJsonCatalogFunction);

defineProperties(RepositoryIdJsonCatalogFunction.prototype, {
    /**
     * Gets the type of data item represented by this instance.
     * @memberOf RepositoryJsonCatalogFunction.prototype
     * @type {String}
     */
    type : {
        get : function() {
    ...
    updaters : {
        get : function() {
            return RepositoryIdJsonCatalogFunction.defaultUpdaters;
        }
    },
    ...
    serializers : {
        get : function() {
            return RepositoryIdJsonCatalogFunction.defaultSerializers;
        }
    },
    ...
    propertiesForSharing : {
        get : function() {
            return RepositoryIdJsonCatalogFunction.defaultPropertiesForSharing;
        }
    },
...
RepositoryIdJsonCatalogFunction.defaultUpdaters = clone(CatalogFunction.defaultUpdaters);

RepositoryIdJsonCatalogFunction.defaultUpdaters.inputs = function(catalogFunction, json, propertyName, options) {
    if (!json.inputs) {
        return;
    }
...
freezeObject(RepositoryIdJsonCatalogFunction.defaultUpdaters);

RepositoryIdJsonCatalogFunction.defaultSerializers = clone(CatalogFunction.defaultSerializers);

RepositoryIdJsonCatalogFunction.defaultSerializers.inputs = function(catalogFunction, json, propertyName, options) {
...
freezeObject(RepositoryIdJsonCatalogFunction.defaultSerializers);

RepositoryIdJsonCatalogFunction.defaultPropertiesForSharing = clone(CatalogFunction.defaultPropertiesForSharing);

RepositoryIdJsonCatalogFunction.prototype._load = function() {
};
 ...
 * @return {Promise}
 */
RepositoryIdJsonCatalogFunction.prototype.invoke = function() {
    var now = new Date();
    ...
    var par = ["http://10.170.138.201:9200/rest/getResult?id=3/20381546"];
    par.forEach(parameter => {
    ...
    /** 1/2048410/item_PIC2TB2DNLRF4XR6GA4JAAGM2NR24WGZ **/
    /** 3/6516083 **/
    /** http://10.170.138.201:9200/rest/getResult?id=1/2048409/item_FOG5OZ2HSDSSUOR4NXI66EGTIHMAHAU3 **/
    const itemList = ['http://10.170.138.201:9200/rest/getResult?id=1/2048409/item_FOG5OZ2HSDSSUOR4NXI66EGTIHMAHAU3', 'http://10.170.138.201:9200/rest/getResult?id=1/2048410/item_PIC2TB2DNLRF4XR6GA4JAAGM2NR24WGZ', 'http://10.170.138.201:9200/rest/getResult?id=3/6516083'];
    var uriTemp = new URI("");
    const uri = uriTemp;
    console.log(uri);
    ...
    const promise = loadJson(proxiedUrl, headers).then(json => {
        ...
        query.featureInfoTemplate.template = "<div class='cho'><center>{{#Preview}}<figure><img src='{{Preview}}'/><figcaption>{{Description}}</figcaption></figure>{{/Preview}}<p><small>by {{Creator}}, {{Temporal}}</small><p><a target='_blank' href={{SourcePage}}><b>{{Repository}} Resource </b></a></center></div>";
...
module.exports = RepositoryIdJsonCatalogFunction;
