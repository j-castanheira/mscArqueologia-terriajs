...
var ObjectTableDataSource = require('../Models/ObjectTableDataSource');
 ...
 */
var ObjectTableCatalogItem = function(terria, url, options) {
    ...
    /**
     * Gets or sets the URL from which the {@link ObjectTableCatalogItem#data} was obtained.  This is informational; it is not
...
inherit(CatalogItem, ObjectTableCatalogItem);
...
defineProperties(ObjectTableCatalogItem.prototype, {
    /**
     * Gets the active time column, if it exists.
     * @memberOf ObjectTableCatalogItem.prototype
     * @type {TableColumn}
     */
    timeColumn: {
        get: function() {
    ...
    propertiesForSharing: {
        get: function() {
            return ObjectTableCatalogItem.defaultPropertiesForSharing;
        }
    },
    ...
    updaters: {
        get: function() {
            return ObjectTableCatalogItem.defaultUpdaters;
        }
    },
    ...
    serializers: {
        get: function() {
            return ObjectTableCatalogItem.defaultSerializers;
        }
    }
});

ObjectTableCatalogItem.defaultUpdaters = clone(CatalogItem.defaultUpdaters);

ObjectTableCatalogItem.defaultUpdaters.tableStyle = function(item, json, propertyName, options) {
    return item._tableStyle.updateFromJson(json[propertyName], options);
};

ObjectTableCatalogItem.defaultUpdaters.polling = function(item, json, propertyName, options) {
    return item[propertyName].updateFromJson(json[propertyName], options);
};

ObjectTableCatalogItem.defaultUpdaters.concepts = function() {
    // Don't update from JSON.
};

ObjectTableCatalogItem.defaultUpdaters.dataViewId = function() {
    // Don't update from JSON.
};

ObjectTableCatalogItem.defaultUpdaters.availableDates = function() {
    // Do not update/serialize availableDates.
};

ObjectTableCatalogItem.defaultUpdaters.intervals = function() {
    // Don't update from JSON.
};

freezeObject(ObjectTableCatalogItem.defaultUpdaters);

ObjectTableCatalogItem.defaultSerializers = clone(CatalogItem.defaultSerializers);

ObjectTableCatalogItem.defaultSerializers.tableStyle = function(item, json, propertyName, options) {
...
ObjectTableCatalogItem.defaultSerializers.polling = function(item, json, propertyName, options) {
    json[propertyName] = item[propertyName].serializeToJson(options);
};

ObjectTableCatalogItem.defaultSerializers.legendUrl = function() {
    // Don't serialize, because legends are generated, and sticking an image embedded in a URL is a terrible idea.
};

ObjectTableCatalogItem.defaultSerializers.concepts = function() {
    // Don't serialize.
};

ObjectTableCatalogItem.defaultSerializers.dataViewId = function() {
    // Don't serialize.
};

ObjectTableCatalogItem.defaultSerializers.dataUrl = function(item, json) {
...
ObjectTableCatalogItem.defaultSerializers.clock = function() {
...
ObjectTableCatalogItem.defaultSerializers.availableDates = function() {
    // Do not update/serialize availableDates.
};

ObjectTableCatalogItem.defaultSerializers.intervals = function() {
    // Don't serialize.
};

freezeObject(ObjectTableCatalogItem.defaultSerializers);
 ...
 * @type {String[]}
 */
ObjectTableCatalogItem.defaultPropertiesForSharing = clone(CatalogItem.defaultPropertiesForSharing);
ObjectTableCatalogItem.defaultPropertiesForSharing.push('keepOnTop');
ObjectTableCatalogItem.defaultPropertiesForSharing.push('opacity');
ObjectTableCatalogItem.defaultPropertiesForSharing.push('tableStyle');
freezeObject(ObjectTableCatalogItem.defaultPropertiesForSharing);


ObjectTableCatalogItem.prototype._getValuesThatInfluenceLoad = function() {
 ...
 */
ObjectTableCatalogItem.applyTableStyleColumnsToStructure = function(tableStyle, tableStructure) {
 ...
 */
ObjectTableCatalogItem.prototype.initializeFromTableStructure = function(tableStructure) {
    var item = this;
 ...
 * lat-lon columns.
 *
 * @param {ObjectTableCatalogItem} item Item that tableDataSource is created for.
...
function createDataSourceForLatLong(item, tableStructure) {
    ...
    item._dataSource = new ObjectTableDataSource(item.terria, tableStructure, item._tableStyle, item.name, (item.polling.seconds > 0));
...
ObjectTableCatalogItem.prototype.setChartable = function() {
 ...
 */
ObjectTableCatalogItem.prototype.setColorOnActiveColumns = function() {
    var tableStructure = this._tableStructure;
 ...
 */
ObjectTableCatalogItem.prototype.activateColumnFromTableStyle = function() {
 ...
 * No return value.
 */
ObjectTableCatalogItem.prototype.startPolling = function() {
 ...
 */
ObjectTableCatalogItem.prototype._load = function() {
...
ObjectTableCatalogItem.prototype._enable = function(layerIndex) {
...
ObjectTableCatalogItem.prototype._disable = function() {
    if (defined(this._regionMapping)) {
...
ObjectTableCatalogItem.prototype._show = function() {
    if (defined(this._dataSource)) {
...
ObjectTableCatalogItem.prototype._hide = function() {
    if (defined(this._dataSource)) {
        var dataSources = this.terria.dataSources;
        if (!dataSources.contains(this._dataSource)) {
 ...
 */
ObjectTableCatalogItem.prototype.getNextColor = function() {
...
/**
 * Returns a {@link ChartData} object for the ObjectTableCatalogItem.  See ChartPanel.jsx for an example.
 *
 * @returns {ChartData}
 */
ObjectTableCatalogItem.prototype.chartData = function() {
    const item = this;
 ...
 * @private
 */
ObjectTableCatalogItem.prototype.disableIncompatibleTableColumns = function() {
...
ObjectTableCatalogItem.prototype.showOnSeparateMap = function(globeOrMap) {
...
module.exports = ObjectTableCatalogItem;
