...
export default class ViewState {
    constructor(options) {
        ...
        //"Id,Title,Creator,Description,Temporal,Location,Latitude,Longitude,Preview,Type,Repository,SourcePage,SourceData\n";
    ...
    addPersonalObject(json) {
        this.personalObjects = json;
        console.log("PEROSNAL", this.personalObjects);
    }
