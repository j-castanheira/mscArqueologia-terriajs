...
export default class ViewState {
    constructor(options) {
        ...
        this.interactionPanelIsVisible = false;
        this.formPanelIsVisible = false;
        ...
        this.interactionPanelAnimating = false;
        this.formPanelAnimating = false;

        //To enable the information window
        this.currentItem = undefined;
        this.currentPropertyPreview = undefined;
        ...
        knockout.track(this, [
            ...
            'formPanelAnimating',
            'interactionPanelAnimating',
            'interactionPanelIsVisible',
            'currentItem',
            'currentPropertyPreview'
        ]);
    ...
    openInteraction(data) {
        ...
        console.log(data);
        this.interactionPanelIsVisible = true;
    }

    openForm() {
        this.formPanelIsVisible = true;
    }
    ...
    searchInRepository(query,rep) {
        this.openAddData();
        // Get the catalog group with the repository search
        console.log(this.terria.catalog._group.items[0].items[rep]);
        this.viewCatalogMember(this.terria.catalog._group.items[0].items[rep]);
        this.previewedItem.inputs[0].value = query;
    }

    viewCatalogMember(catalogMember) {
        console.log("Catakig",catalogMember);
    ...
    changePropertyPreview(property) {
        this.currentPropertyPreview = property;
        console.log(this.currentPropertyPreview);
    }
